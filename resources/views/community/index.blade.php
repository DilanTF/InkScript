    ...
    <div class="py-12 bg-[#F9F7F2] min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-12 text-center">
                ...
                <p class="text-gray-500 text-lg">Sumérgete en miles de historias gratuitas publicadas capítulo a capítulo por autores de todo el mundo.</p>
            </div>
                ...
                <div class="lg:w-1/4">
                    <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 sticky top-8">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            @if(!empty($selectedGenres) || $searchTerm)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md hover:border-[#744E36]/30 transition-all flex flex-col justify-between">
                                <div>
                                    <div class="flex justify-between items-start mb-4">
                                        <span class="px-3 py-1 bg-amber-50 text-amber-700 text-[10px] font-black uppercase tracking-wider rounded-full">{{ $story->genre ?? 'General' }}</span>
                                        <span class="text-xs font-bold text-gray-400">{{ $story->chapters()->count() }} Capítulos</span>
                                    </div>
                        ...
                        @empty
                            <div class="col-span-full bg-white p-12 text-center rounded-3xl border border-dashed border-gray-200">
                                <p class="text-gray-500 text-lg">No hay historias gratuitas con estos filtros.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
