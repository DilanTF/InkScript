...
<head>
    ...
    <title>InkScript - Registrarse</title>
    
    <!-- Fuentes elegantes para mantener la coherencia tipográfica -->
...
<body style="margin: 0; padding: 0; background-color: #f3f4f6; font-family: 'Instrument Sans', ui-sans-serif, system-ui, sans-serif;">
    ...
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center;">
        ...
        <!-- Tarjeta Principal (idéntica a la de Login) -->
        <div style="position: relative; width: 100%; max-width: 1000px; background-color: white; border-radius: 1.5rem; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.15); border: 1px solid #e5e7eb; padding: 5rem 2rem 4rem 2rem; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 700px; box-sizing: border-box;">
            ...
            <!-- Zona del Logo: Arriba a la Izquierda a 10rem -->
            ...
            <div style="width: 100%; max-width: 550px; margin-top: 2rem;">
                <form method="POST" action="{{ route('register') }}" style="display: flex; flex-direction: column; margin: 0;">
                    @csrf
                    ...
                    <div style="display: flex; width: 100%; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); border-radius: 0.5rem; overflow: hidden; border: 1px solid #d1d5db; margin-bottom: 0.5rem; box-sizing: border-box; margin-top: 1.5rem;">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required placeholder="correo@ejemplo.com"
                               style="width: 65%; padding: 1.1rem 1.2rem; background-color: white; color: #1f2937; font-size: 1.05rem; outline: none; border: none; box-sizing: border-box;">
                    </div>
                    ...
                    <div style="position: relative; display: flex; width: 100%; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); border-radius: 0.5rem; overflow: hidden; border: 1px solid #d1d5db; margin-bottom: 0.5rem; box-sizing: border-box; margin-top: 1.5rem;">
                        ...
                        <div style="position: relative; width: 65%;">
                            ...
                            <button type="button" onclick="togglePasswordVisibility('password', 'eye-icon-pass')" style="position: absolute; right: 0.75rem; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #9ca3af; padding: 0.25rem; display: flex; align-items: center; justify-content: center;">
                                <!-- Icono SVG de ojo tachado -->
                                <svg id="eye-icon-pass" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div style="position: relative; display: flex; width: 100%; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); border-radius: 0.5rem; overflow: hidden; border: 1px solid #d1d5db; margin-bottom: 0.5rem; box-sizing: border-box; margin-top: 1.5rem;">
                        ...
                        <div style="position: relative; width: 65%;">
                            ...
                            <!-- Botón interactivo para alternar visibilidad -->
                            <button type="button" onclick="togglePasswordVisibility('password_confirmation', 'eye-icon-confirm')" style="position: absolute; right: 0.75rem; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #9ca3af; padding: 0.25rem; display: flex; align-items: center; justify-content: center;">
                                <!-- Icono SVG de ojo tachado -->
                                <svg id="eye-icon-confirm" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
                                    <line x1="1" y1="1" x2="23" y2="23"></line>
                                </svg>
                            </button>
                    ...
                    <div style="display: flex; align-items: center; justify-content: flex-end; padding-right: 0.25rem; margin-bottom: 2.5rem; margin-top: 1.5rem; width: 100%; box-sizing: border-box;">
                        <a href="{{ route('login') }}" 
